            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div className="bg-card rounded-2xl p-8 velvet-texture">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-card-foreground mb-2">Consultation</h3>
                        <p className="text-muted-foreground">
                          Personal meeting to discuss your style preferences, lifestyle, and specific requirements.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-card-foreground mb-2">Measurement & Last Creation</h3>
                        <p className="text-muted-foreground">
                          Precise foot measurements and creation of your personal wooden last for perfect fit.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-card-foreground mb-2">Design & Material Selection</h3>
                        <p className="text-muted-foreground">
                          Choose from premium leathers, colors, and design details to create your unique shoe.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-card-foreground mb-2">Handcrafting</h3>
                        <p className="text-muted-foreground">
                          Master craftsmen create your shoes using traditional techniques, taking 6-8 weeks.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-card-foreground mb-2">Final Fitting & Delivery</h3>
                        <p className="text-muted-foreground">
                          Final adjustments and presentation of your bespoke shoes with care instructions.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    {leatherOptions.map((leather, index) => (
                      <div
                        ...
                        className={`p-4 rounded-lg border-2 cursor-pointer transition-colors ${
                          selectedLeather === leather.name ? "border-accent bg-accent/10" : "border-accent/20"
                        }`}
                      >
              ...
              <div className="bg-card rounded-2xl p-8 velvet-texture">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Label htmlFor="shoeStyle" className="text-card-foreground">
                      Preferred Shoe Style
                    </Label>
                    <Select value={formData.shoeStyle} onValueChange={(value) => handleInputChange("shoeStyle", value)}>
                      ...
                      <SelectContent className="bg-card border-accent/20">
                        ...
                        <SelectItem value="monk">Monk Strap</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div>
                    <Label htmlFor="specialRequests" className="text-card-foreground">
                      Special Requests & Design Details
                    </Label>
                    <Textarea
                      id="specialRequests"
                      rows={4}
                  ...
                  >
                    {isSubmitted ? "Request Submitted!" : "Submit Bespoke Request"}
                  </Button>
                </form>
                ...
                {isSubmitted && (
                  <div className="mt-6 p-4 bg-accent/10 rounded-lg border border-accent/20">
                    <p className="text-accent font-medium">
                      Thank you for your bespoke request! Our master craftsmen will contact you within 24 hours to
